...
group.test_new_release = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
...
group.test_new_release_with_prefix = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
...
group.test_new_release_candidate = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
    local pre_release = helper.random_int(1, 10)
...
group.test_new_release_candidate_with_prefix = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
    local pre_release = helper.random_int(1, 10)
...
group.test_tostring_release = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
...
group.test_tostring_release_with_prefix = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
...
group.test_tostring_release_candidate = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
    local pre_release = helper.random_int(1, 10)
...
group.test_tostring_release_candidate_with_prefix = function()
    local major = helper.random_int(1, 10)
    local minor = helper.random_int(1, 10)
    local patch = helper.random_int(1, 10)
    local pre_release = helper.random_int(1, 10)

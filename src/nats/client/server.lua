...
local server_info = require('nats.utils.server')


---@class ClientServer class for client work with nats servers
...
---@param self ClientServer class instance
